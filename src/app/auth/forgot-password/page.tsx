...
export default function ForgotPassword() {
    ...
    const handleSubmitPress = (data: EmailForm) => {
        ...
        loginService.forgotPassword(emailConfirm).then((response) => {
            setAlertInfo({
                variant: 'success',
        ...
        <>
            ...
            <div className='loginContainer'>
                ...
                <div className='loginContent'>
                    ...
                    <CustomButton startIcon={<SlLogin size={20} />} onClick={() => handleSubmit(handleSubmitPress)()}>SOLICITAR REDEFINIÇÃO</CustomButton>
